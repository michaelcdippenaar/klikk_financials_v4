...
Pulls Aged Payables By Contact from Xero for one or all connected tenants
and upserts the results into xero_data_agedpayable.
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        for tenant in tenants:
            ...
            try:
                result = sync_aged_payables(tenant, report_date=report_date)
