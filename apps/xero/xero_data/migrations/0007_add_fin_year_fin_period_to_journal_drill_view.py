# Add fin_year and fin_period to v_xero_journal_drill (uses tenant fiscal_year_start_month)
# Must DROP then CREATE because CREATE OR REPLACE cannot change column order
...
# Reverse: recreate original view from 0006 (without fin_year, fin_period)
REVERSE_SQL = """
DROP VIEW IF EXISTS v_xero_journal_drill;
CREATE VIEW v_xero_journal_drill AS
SELECT
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('xero_data', '0006_create_journal_drill_view'),
    ]
